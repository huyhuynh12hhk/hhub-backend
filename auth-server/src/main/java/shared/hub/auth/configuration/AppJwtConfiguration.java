...
public class AppJwtConfiguration {
    ...
    public JWKSource<SecurityContext> jwkSource() {
        // Generate or load RSA keys, store in database if desired
    ...
    @Bean
    public OAuth2TokenGenerator<?> tokenGenerator(JWKSource<SecurityContext> jwkSource, OAuth2TokenCustomizer<JwtEncodingContext> oAuth2TokenCustomizer) {
