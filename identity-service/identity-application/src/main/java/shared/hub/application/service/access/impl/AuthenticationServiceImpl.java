package shared.hub.application.service.access.impl;
...
import shared.hub.infrastructure.persistence.repository.InvalidatedTokenRepository;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public IntrospectResponse introspect(IntrospectRequest request) {
        ...
        log.info("Introspect result is: {}", isValid);
    ...
    public void logout(LogoutRequest request) throws ParseException, JOSEException {
        try {
            ...
            var issueAt = signedJWT.getJWTClaimsSet().getIssueTime();
